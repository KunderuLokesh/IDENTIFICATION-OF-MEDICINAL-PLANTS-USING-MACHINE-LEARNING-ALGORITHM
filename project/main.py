...
training_set = train_datagen.flow_from_directory('C:/Users/lokes/Desktop/project/plant_detection/Dataset/train',
    target_size=(128, 128),
    batch_size=32,
...
test_set = test_datagen.flow_from_directory('C:/Users/lokes/Desktop/project/plant_detection/Dataset/test',  # Make sure this path is correct
    target_size=(128, 128),
    batch_size=34,
    class_mode='categorical'  # Use 'categorical' for multiple classes
)
...
test_image = image.load_img('C:/Users/lokes/Desktop/project/plant_detection/Dataset/single_predection/plant_tulsi.jpg', target_size=(128, 128))
